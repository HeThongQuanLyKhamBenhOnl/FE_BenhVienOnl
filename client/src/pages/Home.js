...
export const Home = () => {
  ...
  const doctors = [
    {
      ...
      description: "Sức khỏe tâm thần",
      image: "https://cdn.bookingcare.vn/fo/2020/01/03/102609-ts-tran-thi-ha-an.jpg",
      link: "/dich-vu-y-te/kham-chuyen-khoa/tien-si-bac-si-tran-thi-ha-an-i189",
    },
    {
      name: "Bác sĩ chuyên khoa II Trần Thị Hoài Hương",
      description: "Da liễu",
      image: "https://cdn.bookingcare.vn/fo/2021/01/14/160049-bs-hoai-huong.jpg",
      link: "/dich-vu-y-te/kham-chuyen-khoa/bac-si-chuyen-khoa-ii-tran-thi-hoai-huong-i1458",
    },
    {
      name: "Thạc sĩ, Bác sĩ Đoàn Thị Lan",
      description: "Nhi khoa",
      image: "https://cdn.bookingcare.vn/fo/2021/10/07/145448-bs-lan.jpg",
      link: "/dich-vu-y-te/kham-chuyen-khoa/thac-si-bac-si-doan-thi-lan-i1880",
    },
    {
      name: "Giáo sư, Tiến sĩ Hà Văn Quyết",
      description: "Tiêu hoá, Bệnh Viêm gan",
      image: "https://cdn.bookingcare.vn/fo/2019/12/31/155650-gs-ha-van-quyet.jpg",
      link: "/dich-vu-y-te/kham-chuyen-khoa/giao-su-tien-si-ha-van-quyet-i56",
    },
    {
      name: "Phó Giáo sư, Tiến sĩ, Bác sĩ Lê Thị Tuyết Lan",
      description: "Hô hấp",
      image: "https://cdn.bookingcare.vn/fo/2019/09/11/105801pho-giao-su-le-thi-tuyet-lan.jpg",
      link: "/dich-vu-y-te/kham-chuyen-khoa/pho-giao-su-tien-si-bac-si-le-thi-tuyet-lan-i851",
    },
  ];

  const Header = () => (
    <div className="flex flex-row items-center justify-between mb-4">
      <h2 className="text-lg font-semibold sm:text-xl lg:text-2xl text-[#1A1A1A]">
        Bác sĩ nổi bật
      </h2>
      <a
        href="/danh-sach/bac-si/noi-bat"
        className="text-sm sm:text-lg font-semibold text-[#34929E] px-4 py-2 sm:bg-[#DAF3F6] rounded-2xl"
      >
        Xem thêm
      </a>
    </div>
  ...
  const DoctorCard = ({ doctor }) => (
    ...
    >
      ...
      <p className="hidden sm:block text-14 lg:text-16 text-[#626262]">
        {doctor.description}
      </p>
    </a>
  );
  ...
  const FeaturedDoctors = () => {
    return (
      <div
        ...
        className="bg-cover bg-center py-10 text-center"
      >
              ...
              <div className="css-175oi2r22">
                <div class="css-175oi2r r-150rngu r-18u37iz r-16y2uox r-1wbh5a2 r-lltvgl r-buy8e9 r-agouwx r-2eszeu">
                  <div class="css-175oi2r r-18u37iz">
                    ...
                    <div class="css-175oi2r r-18u37iz">
                      <a href="/dich-vu-y-te/kham-chuyen-khoa/bac-si-chuyen-khoa-ii-tran-thi-hoai-huong-i1458" dir="auto" data-media="rnmq-cc7f2288 rnmq-4981aede rnmq-33f62820 rnmq-947bd76d rnmq-b16f56f3" class="css-146c3p1  flex flex-col justify-start items-center my-1 mr-6 md:mr-8 lg:mr-10" data-testid="item-1" style={{ width: "264px", }}>
                        <div class="css-175oi2r r-xoduu5 w-[92%] md:w-[84%]">
                          <div class="css-175oi2r r-xoduu5 overflow-hidden rounded-full w-full bc-aspect-ratio[10/10] r-1udh08x">
                    ...
                    <div class="css-175oi2r r-18u37iz">
                      <a href="/dich-vu-y-te/kham-chuyen-khoa/thac-si-bac-si-doan-thi-lan-i1880" dir="auto" data-media="rnmq-cc7f2288 rnmq-4981aede rnmq-33f62820 rnmq-947bd76d rnmq-b16f56f3" class="css-146c3p1  flex flex-col justify-start items-center my-1 mr-6 md:mr-8 lg:mr-10" data-testid="item-2" style={{ width: "264px", }}>
                        <div class="css-175oi2r r-xoduu5 w-[92%] md:w-[84%]">
                          <div class="css-175oi2r r-xoduu5 overflow-hidden rounded-full w-full bc-aspect-ratio[10/10] r-1udh08x">
                    ...
                    <div class="css-175oi2r r-18u37iz">
                      <a href="/dich-vu-y-te/kham-chuyen-khoa/pho-giao-su-tien-si-bac-si-le-thi-tuyet-lan-i851" dir="auto" data-media="rnmq-cc7f2288 rnmq-4981aede rnmq-33f62820 rnmq-947bd76d rnmq-b16f56f3" class="css-146c3p1  flex flex-col justify-start items-center my-1 mr-6 md:mr-8 lg:mr-10" data-testid="item-4" style={{ width: "264px", }}>
                        <div class="css-175oi2r r-xoduu5 w-[92%] md:w-[84%]">
                          <div class="css-175oi2r r-xoduu5 overflow-hidden rounded-full w-full bc-aspect-ratio[10/10] r-1udh08x">
                ...
                <div tabindex="0" class="css-175oi2r r-1i6wzkk r-lrvibr r-1loqt21 r-1otgn73 top-[45%] right-[-18px] py-2 px-3 w-10 h-10 rounded-lg border-1 border-[#B5E7ED] bg-whiteabsolute top-[45%] right-3 py-2 px-3 w-10 h-10 rounded-lg border-1 border-[#B5E7ED] bg-white" data-testid="next-button" style={{ transitionDuration: "0s", }}>
